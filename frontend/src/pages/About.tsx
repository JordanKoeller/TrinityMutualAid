...
import { Jumbotron, TitledSection } from '../components/Jumbotron';
import { SplitPanel } from '../components/SplitPanel';

const AboutPage: React.FC = () => {
  return <div>
    <SplitPanel>
      <Image src="https://dev-tma-files.s3.amazonaws.com/DSCN2178.JPG" fluid />
      <>
        <TitledSection title="Redistributing Wealth">
          <p>
        ...
        <br />
        <TitledSection title="How we Started">
          <p>
